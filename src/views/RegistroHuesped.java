...
public class RegistroHuesped extends JFrame {
	...
	/* public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(2);
  ...
  */
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Booking booking) {
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ReservasView reservas = new ReservasView(booking.getUser_id());
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Date birthDate = new Date(txtFechaN.getDate().getTime());
				String nacionality = txtNacionalidad.getSelectedItem().toString();
				String phoneNumber = txtTelefono.getText();
				long booking_id = bookingController.save(booking);
