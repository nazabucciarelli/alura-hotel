...
public class MenuUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuUsuario frame = new MenuUsuario(1);
	 ...
	 * Create the frame.
	 */
	public MenuUsuario(long userId) {
		this.userId = userId;
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ReservasView reservas = new ReservasView(userId);
		...
		labelRegistro.setBounds(25, 11, 280, 34);
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				Busqueda busqueda = new Busqueda(userId);
	    ...
	    labelFecha.setBounds(35, 64, 350, 36);
	    ...
	    lblNewLabel.setBounds(302, 234, 200, 46);
	    ...
	    lblNewLabel_3_1.setBounds(312, 482, 400, 27);
